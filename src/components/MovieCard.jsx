          ...
          <div className="movie-poster">
            ...
            {isHovered && videoKey && (
              <div className="hover-video-container">
                <iframe
                  src={`https://www.youtube.com/embed/${videoKey}?autoplay=1&mute=1&controls=0&loop=1&playlist=${videoKey}&rel=0&modestbranding=1&iv_load_policy=3&disablekb=1&fs=0`}
                  title="Trailer"
                  frameBorder="0"
